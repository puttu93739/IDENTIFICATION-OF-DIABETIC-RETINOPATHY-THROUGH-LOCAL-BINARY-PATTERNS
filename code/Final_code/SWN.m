function varargout = SWN(varargin)
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SWN_OpeningFcn, ...
                   'gui_OutputFcn',  @SWN_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SWN is made visible.
function SWN_OpeningFcn(hObject, eventdata, handles, varargin)
% Choose default command line output for SWN
...
function varargout = SWN_OutputFcn(hObject, eventdata, handles) 
